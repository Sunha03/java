...
public class ArrayTest04 {
	public static void main(String[] args) {
		//다른 언어와 동일한 방법으로 선언하기 - ,로 배열 요소를 구분함.
		//int[] myarr = new int[5];
		...
		System.out.println("배열 요소의 개수 : " + myarr2.length);
		...
		//String 클래스는 기본형처럼 사용할 수 있음 - 가장 많이 쓰이는 참조형이므로
		String[] strArr2 = { "java", "servlet", "spring", "haoop"};
		System.out.println("개수 : strArr2.length");
